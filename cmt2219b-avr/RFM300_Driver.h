...
#define	TX_ANTOut()	 pinMode(TX_ANT_PIN,OUTPUT)
#define	SetTX_ANT()	 digitalWrite(TX_ANT_PIN,1)
#define	ClrTX_ANT()	 digitalWrite(TX_ANT_PIN,0)

#define	RX_ANTOut()	 pinMode(RX_ANT_PIN,OUTPUT)
#define	SetRX_ANT()	 digitalWrite(RX_ANT_PIN,1)
#define	ClrRX_ANT()	 digitalWrite(RX_ANT_PIN,0)
